...
-module(sheets_module_lex).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("src/sheets_module_lex.xrl", 21).
...
-file("src/sheets_module_lex.erl", 346).
yystate() -> 21.
...
yystate(23, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(23, Ics, Line, Tlen+1, 5, Tlen);
yystate(23, [C|Ics], Line, Tlen, _, _) when C >= 14 ->
    yystate(23, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(22, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(15, Ics, Line, Tlen+1, 2, Tlen);
yystate(22, [C|Ics], Line, Tlen, _, _) when C >= 14 ->
    yystate(15, Ics, Line, Tlen+1, 2, Tlen);
...
yystate(21, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(23, Ics, Line, Tlen+1, 5, Tlen);
yystate(21, [C|Ics], Line, Tlen, _, _) when C >= 14, C =< 36 ->
    yystate(23, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(3, Ics, Line, Tlen+1, 4, Tlen);
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 14, C =< 44 ->
    yystate(3, Ics, Line, Tlen+1, 4, Tlen);
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 46 ->
    yystate(3, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(18, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(15, Ics, Line, Tlen+1, 2, Tlen);
yystate(18, [C|Ics], Line, Tlen, _, _) when C >= 14, C =< 60 ->
    yystate(15, Ics, Line, Tlen+1, 2, Tlen);
...
yystate(17, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(23, Ics, Line, Tlen+1, 5, Tlen);
yystate(17, [C|Ics], Line, Tlen, _, _) when C >= 14, C =< 36 ->
    yystate(23, Ics, Line, Tlen+1, 5, Tlen);
yystate(17, [C|Ics], Line, Tlen, _, _) when C >= 38 ->
    yystate(23, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(16, [10|Ics], Line, Tlen, _, _) ->
    yystate(0, Ics, Line+1, Tlen+1, 3, Tlen);
yystate(16, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(3, Ics, Line, Tlen+1, 3, Tlen);
yystate(16, [C|Ics], Line, Tlen, _, _) when C >= 14, C =< 44 ->
    yystate(3, Ics, Line, Tlen+1, 3, Tlen);
yystate(16, [C|Ics], Line, Tlen, _, _) when C >= 46 ->
    yystate(3, Ics, Line, Tlen+1, 3, Tlen);
...
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(15, Ics, Line, Tlen+1, 4, Tlen);
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 14, C =< 60 ->
    yystate(15, Ics, Line, Tlen+1, 4, Tlen);
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 62 ->
    yystate(15, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(13, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(23, Ics, Line, Tlen+1, 5, Tlen);
yystate(13, [C|Ics], Line, Tlen, _, _) when C >= 14, C =< 36 ->
    yystate(23, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(12, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(3, Ics, Line, Tlen+1, 0, Tlen);
yystate(12, [C|Ics], Line, Tlen, _, _) when C >= 14, C =< 44 ->
    yystate(3, Ics, Line, Tlen+1, 0, Tlen);
...
yystate(11, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(3, Ics, Line, Tlen+1, 4, Tlen);
yystate(11, [C|Ics], Line, Tlen, _, _) when C >= 14 ->
    yystate(3, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(15, Ics, Line, Tlen+1, 4, Tlen);
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 14, C =< 60 ->
    yystate(15, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(9, [C|Ics], Line, Tlen, _, _) when C >= 14, C =< 31 ->
    yystate(15, Ics, Line, Tlen+1, 5, Tlen);
yystate(9, [C|Ics], Line, Tlen, _, _) when C >= 33, C =< 44 ->
    yystate(15, Ics, Line, Tlen+1, 5, Tlen);
yystate(9, [C|Ics], Line, Tlen, _, _) when C >= 46, C =< 60 ->
    yystate(15, Ics, Line, Tlen+1, 5, Tlen);
yystate(9, [C|Ics], Line, Tlen, _, _) when C >= 65 ->
    yystate(15, Ics, Line, Tlen+1, 5, Tlen);
...
yystate(8, [10|Ics], Line, Tlen, _, _) ->
    yystate(0, Ics, Line+1, Tlen+1, 0, Tlen);
yystate(8, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(3, Ics, Line, Tlen+1, 0, Tlen);
yystate(8, [C|Ics], Line, Tlen, _, _) when C >= 14 ->
    yystate(3, Ics, Line, Tlen+1, 0, Tlen);
...
yystate(7, [C|Ics], Line, Tlen, _, _) when C >= 14, C =< 31 ->
    yystate(15, Ics, Line, Tlen+1, 4, Tlen);
yystate(7, [C|Ics], Line, Tlen, _, _) when C >= 33, C =< 44 ->
    yystate(15, Ics, Line, Tlen+1, 4, Tlen);
yystate(7, [C|Ics], Line, Tlen, _, _) when C >= 46, C =< 63 ->
    yystate(15, Ics, Line, Tlen+1, 4, Tlen);
yystate(7, [C|Ics], Line, Tlen, _, _) when C >= 65 ->
    yystate(15, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(3, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(3, Ics, Line, Tlen+1, 3, Tlen);
yystate(3, [C|Ics], Line, Tlen, _, _) when C >= 14 ->
    yystate(3, Ics, Line, Tlen+1, 3, Tlen);
